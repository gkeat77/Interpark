...
public class ComnDtlCodModel {
	...
	/**
	 * @return the dtl_cod_eplti
	 */
	public String getDtl_cod_eplti() {
		return dtl_cod_eplti;
	}

	/**
	 * @param dtl_cod_eplti the dtl_cod_eplti to set
	 */
	public void setDtl_cod_eplti(String dtl_cod_eplti) {
		this.dtl_cod_eplti = dtl_cod_eplti;
	}
	...
	/**
	 * @return the fnl_mdfr_sst
	 */
	public String getFnl_mdfr_sst() {
		return fnl_mdfr_sst;
	}

	/**
	 * @param fnl_mdfr_sst the fnl_mdfr_sst to set
	 */
	public void setFnl_mdfr_sst(String fnl_mdfr_sst) {
		this.fnl_mdfr_sst = fnl_mdfr_sst;
	}
}
