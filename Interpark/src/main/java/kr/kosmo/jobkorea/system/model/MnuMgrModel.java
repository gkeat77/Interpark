...
public class MnuMgrModel {
	...
	// 메뉴 아이콘 명
	private String mnu_ico_nm;
	// 사용 유무
	private String use_poa;
	// 삭제 유무
	private String dlt_poa;
	//자식 node List
	private List<MnuMgrChildModel> nodeList = new ArrayList<MnuMgrChildModel>();
	// 최초 등록 일시
	...
	/**
	 * @return the mnu_ico_nm
	 */
	public String getMnu_ico_nm() {
		return mnu_ico_nm;
	}
	/**
	 * @param mnu_ico_nm the mnu_ico_nm to set
	 */
	public void setMnu_ico_nm(String mnu_ico_nm) {
		this.mnu_ico_nm = mnu_ico_nm;
	}
	/**
	 * @return the use_poa
	 */
	 ...
	 * @return the nodeList
	 */
	public List<MnuMgrChildModel> getNodeList() {
		return nodeList;
	}
	/**
	 * @param nodeList the nodeList to set
	 */
	public void setNodeList(List<MnuMgrChildModel> nodeList) {
