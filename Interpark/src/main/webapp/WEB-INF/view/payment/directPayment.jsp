    ...
    <section class="checkout-section spad">
        <div class="container">
            <form class="checkout-form" name="form">
                        ...
                        <div class="place-order">
                            ...
                            <div class="order-total">
                                <ul class="order-table">
                                    ...
                                    <li class="fw-normal">
                                    	<c:if test="${fn:length(bookInfo.title) > 30}">
										    <c:out value="${fn:substring(bookInfo.title,0,30)}" />...                    
										</c:if>
										<c:if test="${fn:length(bookInfo.title) <= 30}">
										    ${bookInfo.title}
										 </c:if>
                                    	x ${bookInfo.stock } 
                                    	<span><fmt:formatNumber pattern="###,###,###" value="${bookInfo.stock * bookInfo.realPrice}" />원</span></li>
                                    	
                                    	<c:set var="mileage" value="${bookInfo.mileage * bookInfo.stock}"/>
	                                    
	                                    
                                    <!-- <li class="fw-normal">Subtotal <span>$240.00</span></li> -->
                                    <!--bookName, price, stock  -->
                                    <li class="total-price">Total <span id="paymentPrice"><fmt:formatNumber pattern="###,###,###" value="${bookInfo.stock * bookInfo.realPrice}" />원</span>
                                    <li class="total-price">총 할인금액 <span id="dc">원</span>
                                    <li class="total-price">적립될 마일리지<span id="mileage"><c:out value="${mileage}"/>원</span>
                                    <input type="hidden" value="${bookInfo.stock * bookInfo.realPrice}" name="totalPrice" id="totalPrice">
                ...
                <input type="hidden" value="1" name="sw" id="sw">
                <input type="hidden" value="${bookInfo.title}" name="bookName" id="bookName">
                <input type="hidden" value="1" name="sw" id="sw">
            </form>
        </div>
    </section>
